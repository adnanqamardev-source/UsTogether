...
export default function RootLayout({children}: {children: React.ReactNode}) {
  return (
    <html lang="en" className={`${inter.variable} ${playfair.variable}`} style={{minHeight: '100%', margin: 0}}>
      <body className="font-sans antialiased bg-[#0F0A1F] text-[#F8FAFC] min-h-screen flex flex-col font-sans relative overflow-x-hidden overflow-y-auto" suppressHydrationWarning>
