...
- Name: dashboard.spec.ts >> Dashboard Pairing Flow >> button should show loading state during valid pairing attempt
...
Call log:
  - waiting for getByPlaceholder('ENTER PARTNER CODE')
