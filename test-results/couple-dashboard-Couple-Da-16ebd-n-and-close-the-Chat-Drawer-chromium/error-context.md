...
- Name: couple-dashboard.spec.ts >> Couple Dashboard UI >> should open and close the Chat Drawer
- Location: tests\e2e\couple-dashboard.spec.ts:17:7
...
Call log:
  - waiting for getByRole('button', { name: 'Chat' })
