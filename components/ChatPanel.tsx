...
export default function ChatPanel({ messages, user, onClose, onSendMessage }: ChatPanelProps) {
  ...
  return (
    <motion.div
      ...
      className="fixed right-0 top-0 bottom-0 w-full md:w-96 bg-white/5 backdrop-blur-xl shadow-2xl z-50 flex flex-col border-l border-white/10 relative overflow-hidden"
    >
      ...
      {/* Header */}
      <div className="p-4 border-b border-white/10 flex items-center justify-between relative z-10 bg-white/[0.02] backdrop-blur-sm">
      ...
      {/* Toolbar */}
      <div className="hidden lg:flex items-center justify-between px-4 py-2 border-b border-white/10 bg-white/[0.02] backdrop-blur-sm relative z-10">
