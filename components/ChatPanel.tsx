// Inside ChatPanel.tsx return statement:
        ...
        <form onSubmit={handleSend} className="p-4 border-t border-white/10">
          <div className="relative">
            <input
              ...
              // CHANGED: Explicit dark inputs with rose focus rings to match your login button
            ...
            <button
              type="submit"
              disabled={!text.trim()}
              // CHANGED: Button changed to rose-500 to match the main page action button
